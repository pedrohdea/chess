...
def contar_imagens_e_objetos(imagens_dir, labels_dir):
    total_imagens = len(
        [f for f in os.listdir(imagens_dir) if f.endswith((".jpg", ".png"))]
    )
    total_objetos = 0
...
# Caminhos corrigidos
train_imgs, train_objs = contar_imagens_e_objetos(
    "dataset/train/images", "dataset/train/labels"
)
val_imgs, val_objs = contar_imagens_e_objetos(
    "dataset/valid/images", "dataset/valid/labels"
)
test_imgs = len(
    [f for f in os.listdir("dataset/test/images") if f.endswith((".jpg", ".png"))]
)
